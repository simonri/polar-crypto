export default {
  checkout: {
    ...
    crypto: {
      ...
      ctaExplainer:
        'You’ll get a payment address and exact amount on the next step. Nothing is charged until you send it.',
      acceptedHint: 'You can pay with {currencies}.',
      step1Title: 'Open your wallet app',
      step1Body: 'Phantom, Coinbase Wallet, Exodus — or an exchange account.',
      step2Title: 'Scan or paste',
      step2Body: 'the code or address below.',
      step3Title: 'Send the exact amount',
      step3Body: 'We confirm automatically — no need to tell us.',
      feeHelper:
        'Your wallet may add a network fee on top — the amount that arrives must match. Sending from an exchange? Choose “fee paid separately” or add the fee yourself.',
      wrongNetworkWarning:
        '{currency} sent on another network (Ethereum, Base, Polygon…) cannot be recovered.',
      noWallet: 'Don’t have a wallet?',
      noWalletHelp:
        'Install a wallet app — Phantom for Solana/USDC, Muun or BlueWallet for Bitcoin — then buy or transfer crypto into it. Or pay straight from an exchange account (Coinbase, Kraken, Binance): use “Withdraw” or “Send”, paste the address above and pick the matching network.',
      showQr: 'Show QR code',
      hideQr: 'Hide QR code',
      scanQr: 'Scan with your wallet app',
      rateLine: '1 {currency} = {rate}',
      etaInstant: '≈ seconds',
      etaMinutes: '≈ 2–15 min',
      etaSlow: '≈ 10–60 min',
      feeNegligible: 'fee ≈ $0.001',
      feeLow: 'low network fee',
      feeVaries: 'network fee varies',
      ...
      walletPaying: 'Waiting for your wallet…',
      walletPaySent: 'Payment sent from your wallet — waiting for the network…',
      walletPayFailed:
        'The wallet payment didn’t go through — you can still pay with the QR code or address below.',
